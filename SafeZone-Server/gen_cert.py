...
def generate_self_signed_cert():
    ...
    subject = issuer = x509.Name([
        ...
        x509.NameAttribute(NameOID.ORGANIZATION_NAME, u"SafeZone"),
    ...
    cert = x509.CertificateBuilder().subject_name(
        ...
        x509.SubjectAlternativeName([x509.DNSName(u"localhost"), x509.IPAddress(import_ip_address("127.0.0.1"))]),
        critical=False,
